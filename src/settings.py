...
BAN_WORDS = set(line.strip() for line in open('src/res/ban_words.txt', encoding = 'utf-8'))
class Settings:
    ...
    def set_temp_tn_item_list(self, value):
        self.__set_setting("stats_settings", "tickfontsize", value)

    def set_temp_tn_item_list(self, value):
        self.__set_setting("tn_settings", "item_list", value)

    def get_temp_tn_item_list(self):
        return self.__get_config()["tn_settings"]["item_list"]
